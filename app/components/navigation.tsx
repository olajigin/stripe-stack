	...
	return (
		<header
			...
			<Link
				...
				<div className="mx-1" />
				<small className="text-sm font-bold text-violet-200">v2.3</small>
			</Link>
				...
				{user && (
					<>
						...
						<Form
							action="/auth/logout"
							method="post"
							className="flex flex-row items-center text-sm font-semibold text-red-500 
							transition hover:text-red-400 active:text-red-200">
